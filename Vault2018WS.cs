...
namespace vaultgamesesh
{
	public class Late2018WebSock
	{
		...
		public class NotificationWS : WebSocketBehavior
		{
			...
			{
				bool flag = new WebClient().DownloadString("https://raw.githubusercontent.com/NeboOFC/StarRec/main/Update/banned.txt?token=GHSAT0AAAAAACUBHYZXUWXUJNOTK2HRB47YZUHT77Q").Contains(File.ReadAllText("SaveData\\Profile\\userid.txt"));
				if (flag)
				{
