...
namespace api
{
    class Config
    {
        public static void setup()
        {
            ...
            {
                File.WriteAllBytes("SaveData\\profileimage.png", new WebClient().DownloadData("https://raw.githubusercontent.com/NeboOFC/StarRec/main/profileimage.png?token=GHSAT0AAAAAACUBHYZXFA6ZISKPRFLR7DWYZUHTF6A"));
            }
