    ...
    class Program
    {
        ...
        Tutorial:
            if (Setup.firsttime == true)
            {
                ...
                Console.Title = "StarRec Intro";
                Console.WriteLine("Welcome to StarRec " + appversion + "!");
                Console.WriteLine("Is this your first time using StarRec?");
                Console.WriteLine("Yes or No (Y, N)");
                string readline22 = Console.ReadLine();
                if (readline22 == "y" || readline22 == "Y")
                {
                    Console.Clear();
                    Console.Title = "StarRec Tutorial";
                    Console.WriteLine("In that case, welcome to StarRec!");
                    Console.WriteLine("StarRec is server software that emulates the old servers of previous RecRoom versions.");
                    Console.WriteLine("To use StarRec, you'll need to have builds aswell!");
                    ...
                    Console.WriteLine(new WebClient().DownloadString("https://raw.githubusercontent.com/NeboOFC/StarRec/main/Update/builds.txt?token=GHSAT0AAAAAACUBHYZWBY2ELCUDSV7VBFY4ZUHTKRA"));
        ...
        Start:
            Console.Title = "StarRec Startup Menu";
            Console.ForegroundColor = ConsoleColor.DarkMagenta;
            Console.WriteLine("StarRec -  Old RecRoom server software. (Version: " + appversion + ")");
            Console.WriteLine("Discord: https://discord.gg/dQ6yXcCq" + Environment.NewLine);
            if (!(new WebClient().DownloadString("https://raw.githubusercontent.com/NeboOFC/StarRec/main/Download/version.txt?token=GHSAT0AAAAAACUBHYZXIS7OEQSZHKSYWKLEZUHTOCA").Contains(appversion)))
            {
                Console.WriteLine("This version of StarRec is outdated. We recommend you install the latest version, StarRec " + new WebClient().DownloadString("https://raw.githubusercontent.com/NeboOFC/StarRec/main/Download/version.txt?token=GHSAT0AAAAAACUBHYZXIS7OEQSZHKSYWKLEZUHTOCA"));
            }
            if (File.Exists("SaveData\\Profile\\userid.txt"))
            {
                if (new WebClient().DownloadString("https://raw.githubusercontent.com/NeboOFC/StarRec/main/Update/banned.txt?token=GHSAT0AAAAAACUBHYZWYJ2TR7G3JHSSHXNGZUHTPQQ").Contains(File.ReadAllText("SaveData\\Profile\\userid.txt")))
                {
                    Console.ForegroundColor = ConsoleColor.Red;
                    Console.WriteLine("You are banned. Using this version of StarRec will not work, please download StarRec 0.0.2 or prior.");
                    Console.ForegroundColor = ConsoleColor.DarkMagenta;
                    bannedflag = true;
                }
            }
            Console.WriteLine("//Custom Room Downloader has been moved to the settings tab!" + Environment.NewLine);
            Console.WriteLine("(1) What's New" + Environment.NewLine +"(2) Change Settings" + Environment.NewLine + "(3) Profile Editor" + Environment.NewLine + "(4) Build Download Links" + Environment.NewLine + "(5) Start Server");
            string readline = Console.ReadLine();
            if (readline == "1")
            {
                Console.Title = "StarRec Changelog";
                Console.Clear();
                Console.WriteLine(new WebClient().DownloadString("https://github.com/NeboOFC/StarRec/blob/main/Download/changelog.txt"));
            ...
            if (readline == "2")
            {
                ...
                Settings:
                Console.Title = "StarRec Settings Menu";
                ...
                {
                    Console.Title = "StarRec Custom Room Downloader";
                    Console.Clear();
            ...
            Profile:
                Console.Title = "StarRec Profile Menu";
                ...
                else if (readline3 == "2")
                {
                    ...
                    else if (readline4 == "2")
                    {
                        ...
                        {
                            Console.Clear();
                            Console.WriteLine("Invalid Image (Make sure its on the same drive as StarRec)");
                            goto Profile;
                        }
                        Console.Clear();
                        Console.WriteLine("Success!");
                ...
                {
                    Console.Title = "StarRec Profile Downloader";
                    Console.Clear();
                    Console.WriteLine("Profile Downloader: This tool takes the username and profile image of any username you type in and imports it to StarRec.");
            ...
            if (readline == "4")
            {
                Console.Title = "StarRec Build Downloads";
                Console.Clear();
                Console.WriteLine("To download builds, either go to the builds channel or use the links below: (these links are also available from the #builds channel)" + Environment.NewLine);
                Console.WriteLine(new WebClient().DownloadString("https://raw.githubusercontent.com/NeboOFC/StarRec/main/Update/builds.txt"));
                Console.WriteLine("Download a build and press any key to continue:");
                Console.ReadKey();
                Console.Clear();
                goto Start;
            ...
            if (readline == "5")
            {
                ...
                {
                    Console.Title = "StarRec October 19th 2017";
                    version = "2017";
                    Console.Clear();
                ...
                else if (readline2 == "2018")
                {
                    ...
                    {
                        Console.Title = "StarRec May 30th 2018";
                        version = "2018";
                        Console.Clear();
                    ...
                    {
                        Console.Title = "StarRec September 27th 2018";
                        version = "2018";
                        Console.Clear();
                    ...
                    {
                        Console.Title = "StarRec July 20th 2018";
                        version = "2018";
                        Console.Clear();
