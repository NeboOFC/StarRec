...
namespace api
{
	...
	internal class Config2
	{
		...
		public static string GetDebugConfig()
		{
			...
			{
				MessageOfTheDay = new WebClient().DownloadString("https://raw.githubusercontent.com/NeboOFC/StarRec/main/Update/motd.txt?token=GHSAT0AAAAAACUBHYZWRHERK4MBEZOPUS5WZUHTG7Q"),
